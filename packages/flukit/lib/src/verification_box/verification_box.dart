...
class _VerificationBox extends State<VerificationBox> {
  ...
  @override
  void initState() {
    List.generate(widget.count, (final index) {
      _contentList.add('');
    });
  ...
  void _onValueChange(final value) {
