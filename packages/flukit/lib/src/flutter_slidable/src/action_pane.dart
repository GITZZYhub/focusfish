...
class ActionPaneData {
  ...
  const ActionPaneData({
    required final this.extentRatio,
    required final this.alignment,
    required final this.direction,
    required final this.fromStart,
...
class ActionPane extends StatefulWidget {
  ...
  const ActionPane({
    final Key? key,
    final this.extentRatio = _defaultExtentRatio,
    required final this.motion,
    final this.dismissible,
    final this.openThreshold,
    final this.closeThreshold,
    required final this.children,
  ...
  static ActionPaneData? of(final BuildContext context) => context
...
class ActionPaneState extends State<ActionPane> implements RatioConfigurator {
  ...
  @override
  void didUpdateWidget(covariant final ActionPane oldWidget) {
  ...
  @override
  bool canChangeRatio(final double ratio) =>
      widget.dismissible != null || ratio <= widget.extentRatio;
...
class _ActionPaneScope extends InheritedWidget {
  ...
  @override
  bool updateShouldNotify(covariant final _ActionPaneScope oldWidget) =>
      oldWidget.actionPaneData != actionPaneData;
}
