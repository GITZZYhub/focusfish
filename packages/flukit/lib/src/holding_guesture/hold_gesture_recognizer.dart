...
typedef GestureHoldCallback = void Function();
...
typedef GestureHoldCancelCallback = void Function();

const int kHoldMilliseconds = 300;
const Duration kHoldTimeout = Duration(milliseconds: kHoldMilliseconds);
