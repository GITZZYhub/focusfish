...
class PositionedList extends StatefulWidget {
  ...
  const PositionedList({
    ...
    final this.separatorBuilder,
    final this.controller,
    final this.itemPositionsNotifier,
    final this.positionedIndex = 0,
    final this.alignment = 0,
    final this.scrollDirection = Axis.vertical,
    final this.reverse = false,
    final this.physics,
    final this.padding,
    final this.cacheExtent,
...
class _PositionedListState extends State<PositionedList> {
  ...
  @override
  void didUpdateWidget(final PositionedList oldWidget) {
    super.didUpdateWidget(oldWidget);
    _schedulePositionNotificationUpdate();
  }

  @override
  Widget build(final BuildContext context) => RegistryWidget(
  ...
  Widget _buildSeparatedListElement(final int index) {
    if (index.isEven) {
  ...
  Widget _buildItem(final int index) => RegisteredElementWidget(
        key: ValueKey(index),
